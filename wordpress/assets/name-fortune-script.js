(function($) {
    ...
    $(document).ready(function() {
         ...
         * Reference: domainTest/script.js - complete 81 fortune interpretations
         */
        function getFortuneMessage(mod81) {
            // Handle mod81 === 0 case (should map to 81)
            const score = mod81 === 0 ? 81 : mod81;
        ...
        function calculateFortune(name) {
            ...
            // Calculate mod 81 (0 maps to 81, consistent with domainTest)
            const mod81WithSpace = asciiSumWithSpace % 81 === 0 ? 81 : asciiSumWithSpace % 81;
            const mod81WithoutSpace = asciiSumWithoutSpace % 81 === 0 ? 81 : asciiSumWithoutSpace % 81;
